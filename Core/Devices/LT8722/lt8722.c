...
{
	return lt8722_reg_write(LT8722_SPIS_STATUS, 0);
}
...
int8_t lt8722_get_dac(uint32_t *value)
{
	int ret;
	uint32_t data;
	ret = lt8722_reg_read(LT8722_SPIS_DAC, &data);
	if (ret)
		return ret;
...
int8_t lt8722_get_spis_ov_clamp(uint8_t *value)
{
	int ret;
	uint32_t data;
	ret = lt8722_reg_read(LT8722_SPIS_OV_CLAMP, &data);
	if (ret)
		return ret;
...
int8_t lt8722_get_spis_uv_clamp(uint8_t *value)
{
	int ret;
	uint32_t data;
	ret = lt8722_reg_read(LT8722_SPIS_UV_CLAMP, &data);
	if (ret)
		return ret;
